export const rewards = [
    ...
    { points: 25, description: 'Open equipment T3 complect' },
    ...
    { points: 200, description: 'Open equipment T4 complect' },
    ...
    { points: 1000, description: '+20% to find soul per Rebirth Tier' },
    ...
    { points: 4000, description: 'Open equipment T5 complect' },
    { points: 5000, description: '+10 Potential' },
    { points: 7500, description: 'Unlock new BUFF: Flexible' },
    { points: 9000, description: 'EVO LOOT affects to Rebirth Pts' },
    ...
    { points: 20000, description: '+1% to skip stage when you kill enemy. It works until 25% Max Stage Reached' },
