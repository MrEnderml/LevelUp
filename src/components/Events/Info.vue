...
const statSections = [
  {
    ...
    content: [
      ...
      { desc: `Infinity Penalty Reduction`, value: '', color: 'gold',  uppercase: true, req: () => hero.value.infPenalty > 0 },
      {
      ...
      { desc: `Total`, value: '', color: 'gold',  uppercase: true, req: () => hero.value.infPenalty > 0 },
      {
        desc: 'Total',
